...
<body>
    ...
    <section class="pages">
        <div class="container">
            <span class="section-tag">Инновационная экосистема</span>
            <h1>Контактная информация</h1>

            <p class="lead-text">
                Мы всегда открыты для новых проектов, обсуждения передовых цифровых инфраструктур и AI-решений. 
            ...
            <div class="contact-cards">
                <div class="contact-card">
                    ...
                    <h2>Пишите нам</h2>
                    <p>Для общих вопросов, предложений по обучению и AI-инструментам:</p>
                ...
                <div class="contact-card">
                    ...
                    <h2>Звоните</h2>
                    <p>Прямая линия экспертной поддержки и консультаций по программам:</p>
                    <a href="tel:+390697639463" class="contact-link">+39 06 9763 9463</a>
                </div>
                ...
                <div class="contact-card">
                    ...
                    <h2>Наш офис</h2>
                    <p>Центр разработки и консалтинга <strong><?= $domainTitle ?></strong> в Италии:</p>
